...
def gboost_regressor(df, param_ranges, model_save_path, log_file_path, plot_save_path, scaler_save_path, target_type, al_type):
    # Preprocessing
...
def main():
    ...
    for file in files:
        ...
        gboost_regressor(df, param_ranges, model_save_path, log_file_path, plot_save_path, scaler_save_path, target_type, al_type)
